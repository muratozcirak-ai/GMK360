...
with open('scratch/Details_fix.cshtml', 'r', encoding='utf-8') as f:
    html = f.read()

# Find the accordion block
pattern = re.compile(r'<div class="accordion mb-4 shadow-sm" id="accordionSummaries">.*?<!-- TASLAK', re.DOTALL)

clean_accordion = r'''<div class="accordion mb-4 shadow-sm" id="accordionSummaries">
