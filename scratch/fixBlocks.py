...
pattern = r'<h4 class="fw-bold mb-3"><i class="bi bi-grid-1x2 text-orange me-2"></i>Projedeki Bloklar / Binalar</h4>.*?<!-- TASLAK / KONU TARTI\w+ B\w+L\w+M\w+ -->'
                    ...
                    <div class="card border border-danger border-opacity-25 shadow-sm rounded-4 h-100">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <h5 class="fw-bold text-danger mb-0">@block.Name</h5>
                                <span class="px-2 py-1 bg-light text-dark border rounded small"><i class="bi bi-layers me-1"></i>@(block.TotalFloors) Kat</span>
                            </div>
                            
                            <div class="d-flex justify-content-between text-muted small mb-4">
                                <div><i class="bi bi-door-open me-1"></i>@(block.TotalUnits) Daire, @(block.TotalShops) Dükkan</div>
            ...
            @foreach (var block in newBlocks)
            {
                <div class="col-md-6 col-lg-4">
                    <div class="card border border-primary border-opacity-25 shadow-sm rounded-4 h-100">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <h5 class="fw-bold text-primary mb-0">@block.Name</h5>
                                <span class="px-2 py-1 bg-light text-dark border rounded small"><i class="bi bi-layers me-1"></i>@(block.TotalFloors) Kat</span>
                            </div>
