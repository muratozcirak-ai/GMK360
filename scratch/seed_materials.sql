...
BEGIN
    INSERT INTO DefinitionCategories (Name, SystemCode, Description, IconClass, IsActive, CreatedAt, IsDeleted)
    VALUES ('B2B Malzeme Tedarik Sektörleri', 'B2BMaterialCategories', 'Tedarikçi ve Nalburların malzeme kategorileri', 'ph-package', 1, GETUTCDATE(), 0);
