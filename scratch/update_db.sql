USE GMK360Db;
GO
ALTER TABLE SystemLegalDocumentTemplates DROP COLUMN TargetModule;
ALTER TABLE SystemLegalDocumentTemplates DROP COLUMN Stage;
ALTER TABLE SystemLegalDocumentTemplates DROP COLUMN DisplayOrder;
ALTER TABLE SystemLegalDocumentTemplates DROP COLUMN IsMandatory;
GO
