    ...
    function openManageModal(id) {
        fetch('/ConstructionProject/GetDocumentDetails/' + id)
            ...
            .then(data => {
                ...
                document.getElementById('modalStartDate').value = data.startDate ? data.startDate.split('T')[0] : '';
                document.getElementById('modalCompletedDate').value = data.completedDate ? data.completedDate.split('T')[0] : '';
...
if "id=\"manageDocModal\"" not in content:
    content = content + "\n" + modal_html
