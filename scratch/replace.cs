...
class Program
{
    static void Main()
    {
        string path = @""GMK360.Web\Views\ConstructionProject\Details.cshtml"";
        string content = File.ReadAllText(path);
        
        string pattern = @""(?s)<div class=\""row g-4 mb-4\"">.*?<!-- TASLAK"";
        
        string replacement = @""<!-- HARİTA VE ÇEVRE ÖZELLİKLERİ (BAĞIMSIZ) -->
                ...
                <div class=\""row g-4\"">
                    ...
                    <div class=\""col-md-4\"">
                        <div class=\""card border-0 shadow-sm rounded-4 w-100 overflow-hidden\"" style=\""height: 250px;\"">
                            ...
                            {
                                <img src=\""@Model.CoverImageUrl\"" class=\""img-fluid h-100 w-100\"" style=\""object-fit: cover;\"" alt=\""Proje Görseli\"" />
                            }
                            else
                            {
