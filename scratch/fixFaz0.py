...
# Now we must add an extra closing bracket at the end of the loop!
end_pattern = r'                                              }
                                          </td>
                                          <td>
                                              <a href="#" class="btn btn-sm btn-outline-primary rounded-pill px-3" data-bs-toggle="modal" data-bs-target="#editDocModal" data-doc-id="@doc.Id"><i class="bi bi-pencil me-1"></i> Ynet</a>
                                          </td>
                                      </tr>
                                  }
                              }
