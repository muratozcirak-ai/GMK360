...
";
        ...
        int startIdx = text.IndexOf(@"<div class=""card shadow-sm rounded-4 border-0 mb-5"">");
        int endIdx = text.IndexOf(@"<div class=""row g-5"">", startIdx);
        
        if(startIdx != -1 && endIdx != -1)
        {
            text = text.Remove(startIdx, endIdx - startIdx);
            text = text.Insert(startIdx, newTopCard);
