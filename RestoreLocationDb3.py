...
# Extract block starting with "INSERT INTO olt_ilceler" and ending with ";"
ilce_blocks = re.findall(r'INSERT INTO olt_ilceler.*?VALUES(.*?);', content, re.DOTALL)
ilceler = []
if ilce_blocks:
...
semt_blocks = re.findall(r'INSERT INTO olt_semtler.*?VALUES(.*?);', content, re.DOTALL)
semtler = {}
if semt_blocks:
...
mahalle_blocks = re.findall(r'INSERT INTO olt_mahalleler.*?VALUES(.*?);', content, re.DOTALL)
mahalleler = []
if mahalle_blocks:
    for block in mahalle_blocks:
        # Match something like: (1, 1, 'Akpınar Mah', '01330')
