...
class Program
{
    static void Main()
    {
        ...
        {
            code = code.Replace("public List<ConstructionTask> Tasks { get; set; }", "public ProjectLifecycleStatus LifecycleStatus { get; set; } = ProjectLifecycleStatus.UnderConstruction;\r\n        public List<ConstructionTask> Tasks { get; set; }");
